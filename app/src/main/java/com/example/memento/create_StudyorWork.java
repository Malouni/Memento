...
public class create_StudyorWork extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> hours = new ArrayAdapter<String>(create_StudyorWork.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.hours));
        ...
        ArrayAdapter<String> minutes = new ArrayAdapter<String>(create_StudyorWork.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.minutes));
        hours.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
